...
perfil = st.sidebar.selectbox("🧳 Perfil de Viajero", sorted(full_df["perfil_viajero"].dropna().unique())).strip().title()
entorno = st.sidebar.selectbox("🏔️ Tipo de Entorno", sorted(full_df["entornos"].dropna().unique())).strip().title()
clasificacion = st.sidebar.selectbox("🏷️ Tipo de Experiencia", sorted(full_df["clasificacion_destino"].dropna().unique())).strip().title()
temporada = st.sidebar.selectbox("📅 Temporada", sorted(full_df["temporada"].dropna().unique())).strip().title()
clase = st.sidebar.selectbox("🛫 Clase del Vuelo", sorted(full_df["class"].dropna().unique())).strip().title()
origen = st.sidebar.selectbox("🛫 Ciudad de Origen", sorted(full_df["origin_city"].dropna().unique())).strip().title()
